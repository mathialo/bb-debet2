...
package com.mathiaslohne.bbdebet2.gui;

import com.mathiaslohne.bbdebet2.kernel.core.KernelAlreadyRunningException;
import com.mathiaslohne.bbdebet2.gui.controllers.AdminController;
import com.mathiaslohne.bbdebet2.gui.controllers.LoginController;
import com.mathiaslohne.bbdebet2.gui.controllers.UserController;
    ...
    public void start(Stage primaryStage) {
        ...
        try {
            loginRoot = FXMLLoader.load(
                getClass().getClassLoader().getResource("com/mathiaslohne/bbdebet2/gui/views/LoginScreen.fxml"));
            loginScene = new Scene(loginRoot);

            userRoot = FXMLLoader.load(
                getClass().getClassLoader().getResource("com/mathiaslohne/bbdebet2/gui/views/UserScreen.fxml"));
            userScene = new Scene(userRoot);

            adminRoot = FXMLLoader.load(
                getClass().getClassLoader().getResource("com/mathiaslohne/bbdebet2/gui/views/AdminScreen.fxml"));
